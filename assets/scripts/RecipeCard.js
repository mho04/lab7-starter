...
class dataCard extends HTMLElement {
	// Called once when document.createElement('data-card') is called, or
	// the element is written into the DOM directly as <data-card>
	constructor() {
	 ...
	 *
	 * For example:
	 * let dataCard = document.createElement('data-card'); // Calls constructor()
	 * dataCard.data = { foo: 'bar' } // Calls set data({ foo: 'bar' })
	 *
	 * @param {Object} data - The data to pass into the <data-card> must be of the
	 *                        following format:
	 *                        {
	 *                          "imgSrc": "string",
	 *                          "imgAlt": "string",
